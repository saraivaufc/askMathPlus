    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Escolha uma cor para a categoria.', max_length=50, verbose_name='Cor', choices=[(b'bg-lime', 'Lime'), (b'bg-green', 'Green'), (b'bg-emerald', 'Emerald'), (b'bg-teal', 'Teal'), (b'bg-blue', 'Blue'), (b'bg-cyan', 'Cyan'), (b'bg-cobalt', 'Cobalt'), (b'bg-indigo', 'Indigo'), (b'bg-violet', 'Violet'), (b'bg-magenta', 'Magenta'), (b'bg-orange', 'Orange'), (b'bg-amber', 'Amber'), (b'bg-yellow', 'Yellow'), (b'bg-brown', 'Brown'), (b'bg-olive', 'Emerald'), (b'bg-steel', 'Steel'), (b'bg-mauve', 'Mauve'), (b'bg-taupe', 'Taupe'), (b'bg-gray', 'Gray'), (b'bg-lightBlue', 'Light Blue'), (b'bg-lightRed', 'Light Red'), (b'bg-lightGreen', 'Light Green'), (b'bg-lighterBlue', 'Lighter Blue'), (b'bg-lightOlive', 'Light Olive'), (b'bg-lightOrange', 'Light Orange'), (b'bg-darkBrown', 'Dark Brown'), (b'bg-darkIndigo', 'Dark Indigo'), (b'bg-darkCyan', 'Dark Cyan'), (b'bg-darkCobalt', 'Dark Cobalt'), (b'bg-darkTeal', 'Dark Teal'), (b'bg-darkEmerald', 'Dark Emerald'), (b'bg-darkGreen', 'Dark Green'), (b'bg-darkOrange', 'Dark Orange'), (b'bg-darkViolet', 'Dark Violet'), (b'bg-darkBlue', 'Dark Blue')])),
                ('creation', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Cria\xe7\xe3o')),
                ('exists', models.BooleanField(default=True, verbose_name='Existe')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(help_text='Escolha um nome para a turma.', max_length=100, verbose_name='Nome')),
                ('semester', models.FloatField(help_text='Escolha o semestre dessa turma.', verbose_name='Semestre')),
                ('plan', models.FileField(help_text='Realize upload de um arquivo.', upload_to=b'documents/plans/%Y/%m/%d', null=True, verbose_name='Plano de Aula', blank=True)),
                ('visible', models.BooleanField(default=False, help_text='Escolha esta op\xe7\xe3o para tornar a turma vis\xedvel \xe0 todos.', verbose_name='Vis\xedvel')),
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Escolha uma cor para esta turma.', max_length=50, verbose_name='Cor', choices=[(b'bg-lime', 'Lime'), (b'bg-green', 'Green'), (b'bg-emerald', 'Emerald'), (b'bg-teal', 'Teal'), (b'bg-blue', 'Blue'), (b'bg-cyan', 'Cyan'), (b'bg-cobalt', 'Cobalt'), (b'bg-indigo', 'Indigo'), (b'bg-violet', 'Violet'), (b'bg-magenta', 'Magenta'), (b'bg-orange', 'Orange'), (b'bg-amber', 'Amber'), (b'bg-yellow', 'Yellow'), (b'bg-brown', 'Brown'), (b'bg-olive', 'Emerald'), (b'bg-steel', 'Steel'), (b'bg-mauve', 'Mauve'), (b'bg-taupe', 'Taupe'), (b'bg-gray', 'Gray'), (b'bg-lightBlue', 'Light Blue'), (b'bg-lightRed', 'Light Red'), (b'bg-lightGreen', 'Light Green'), (b'bg-lighterBlue', 'Lighter Blue'), (b'bg-lightOlive', 'Light Olive'), (b'bg-lightOrange', 'Light Orange'), (b'bg-darkBrown', 'Dark Brown'), (b'bg-darkIndigo', 'Dark Indigo'), (b'bg-darkCyan', 'Dark Cyan'), (b'bg-darkCobalt', 'Dark Cobalt'), (b'bg-darkTeal', 'Dark Teal'), (b'bg-darkEmerald', 'Dark Emerald'), (b'bg-darkGreen', 'Dark Green'), (b'bg-darkOrange', 'Dark Orange'), (b'bg-darkViolet', 'Dark Violet'), (b'bg-darkBlue', 'Dark Blue')])),
                ('creation', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Cria\xe7\xe3o')),
                ('exists', models.BooleanField(default=True, verbose_name='Existe')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Escolha uma cor para a disciplina.', max_length=50, verbose_name='Cor', choices=[(b'bg-lime', 'Lime'), (b'bg-green', 'Green'), (b'bg-emerald', 'Emerald'), (b'bg-teal', 'Teal'), (b'bg-blue', 'Blue'), (b'bg-cyan', 'Cyan'), (b'bg-cobalt', 'Cobalt'), (b'bg-indigo', 'Indigo'), (b'bg-violet', 'Violet'), (b'bg-magenta', 'Magenta'), (b'bg-orange', 'Orange'), (b'bg-amber', 'Amber'), (b'bg-yellow', 'Yellow'), (b'bg-brown', 'Brown'), (b'bg-olive', 'Emerald'), (b'bg-steel', 'Steel'), (b'bg-mauve', 'Mauve'), (b'bg-taupe', 'Taupe'), (b'bg-gray', 'Gray'), (b'bg-lightBlue', 'Light Blue'), (b'bg-lightRed', 'Light Red'), (b'bg-lightGreen', 'Light Green'), (b'bg-lighterBlue', 'Lighter Blue'), (b'bg-lightOlive', 'Light Olive'), (b'bg-lightOrange', 'Light Orange'), (b'bg-darkBrown', 'Dark Brown'), (b'bg-darkIndigo', 'Dark Indigo'), (b'bg-darkCyan', 'Dark Cyan'), (b'bg-darkCobalt', 'Dark Cobalt'), (b'bg-darkTeal', 'Dark Teal'), (b'bg-darkEmerald', 'Dark Emerald'), (b'bg-darkGreen', 'Dark Green'), (b'bg-darkOrange', 'Dark Orange'), (b'bg-darkViolet', 'Dark Violet'), (b'bg-darkBlue', 'Dark Blue')])),
                ('creation', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Cria\xe7\xe3o')),
                ('exists', models.BooleanField(default=True, verbose_name='Existe')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('errors_followed_to_obstacle', models.IntegerField(help_text='Escolha a quantidade de erros para o obst\xe1culo.', verbose_name='Erros para Obst\xe1culo.')),
                ('errors_to_deficiency', models.IntegerField(help_text='Escolha a quantidade de erros para o obst\xe1culo.', verbose_name='Erros para a Defici\xeancia')),
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Escolha uma cor para esta li\xe7\xe3o.', max_length=50, verbose_name='Cor', choices=[(b'bg-lime', 'Lime'), (b'bg-green', 'Green'), (b'bg-emerald', 'Emerald'), (b'bg-teal', 'Teal'), (b'bg-blue', 'Blue'), (b'bg-cyan', 'Cyan'), (b'bg-cobalt', 'Cobalt'), (b'bg-indigo', 'Indigo'), (b'bg-violet', 'Violet'), (b'bg-magenta', 'Magenta'), (b'bg-orange', 'Orange'), (b'bg-amber', 'Amber'), (b'bg-yellow', 'Yellow'), (b'bg-brown', 'Brown'), (b'bg-olive', 'Emerald'), (b'bg-steel', 'Steel'), (b'bg-mauve', 'Mauve'), (b'bg-taupe', 'Taupe'), (b'bg-gray', 'Gray'), (b'bg-lightBlue', 'Light Blue'), (b'bg-lightRed', 'Light Red'), (b'bg-lightGreen', 'Light Green'), (b'bg-lighterBlue', 'Lighter Blue'), (b'bg-lightOlive', 'Light Olive'), (b'bg-lightOrange', 'Light Orange'), (b'bg-darkBrown', 'Dark Brown'), (b'bg-darkIndigo', 'Dark Indigo'), (b'bg-darkCyan', 'Dark Cyan'), (b'bg-darkCobalt', 'Dark Cobalt'), (b'bg-darkTeal', 'Dark Teal'), (b'bg-darkEmerald', 'Dark Emerald'), (b'bg-darkGreen', 'Dark Green'), (b'bg-darkOrange', 'Dark Orange'), (b'bg-darkViolet', 'Dark Violet'), (b'bg-darkBlue', 'Dark Blue')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default=None, upload_to=b'documents/image/question/%Y/%m/%d', blank=True, help_text='Por favor, entre com uma image.', null=True, verbose_name='Imagem')),
                ('help', models.TextField(help_text='Escolha uma ajuda para esta pergunta.', null=True, verbose_name='Ajuda', blank=True)),
                ('scores', models.IntegerField(default=5, verbose_name='Pontos', choices=[(1, b'1'), (2, b'2'), (3, b'3'), (4, b'4'), (5, b'5'), (6, b'6'), (7, b'7'), (8, b'8'), (9, b'9'), (10, b'10')])),
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Escolha uma cor para esta quest\xe3o.', max_length=50, verbose_name='Cor', choices=[(b'bg-lime', 'Lime'), (b'bg-green', 'Green'), (b'bg-emerald', 'Emerald'), (b'bg-teal', 'Teal'), (b'bg-blue', 'Blue'), (b'bg-cyan', 'Cyan'), (b'bg-cobalt', 'Cobalt'), (b'bg-indigo', 'Indigo'), (b'bg-violet', 'Violet'), (b'bg-magenta', 'Magenta'), (b'bg-orange', 'Orange'), (b'bg-amber', 'Amber'), (b'bg-yellow', 'Yellow'), (b'bg-brown', 'Brown'), (b'bg-olive', 'Emerald'), (b'bg-steel', 'Steel'), (b'bg-mauve', 'Mauve'), (b'bg-taupe', 'Taupe'), (b'bg-gray', 'Gray'), (b'bg-lightBlue', 'Light Blue'), (b'bg-lightRed', 'Light Red'), (b'bg-lightGreen', 'Light Green'), (b'bg-lighterBlue', 'Lighter Blue'), (b'bg-lightOlive', 'Light Olive'), (b'bg-lightOrange', 'Light Orange'), (b'bg-darkBrown', 'Dark Brown'), (b'bg-darkIndigo', 'Dark Indigo'), (b'bg-darkCyan', 'Dark Cyan'), (b'bg-darkCobalt', 'Dark Cobalt'), (b'bg-darkTeal', 'Dark Teal'), (b'bg-darkEmerald', 'Dark Emerald'), (b'bg-darkGreen', 'Dark Green'), (b'bg-darkOrange', 'Dark Orange'), (b'bg-darkViolet', 'Dark Violet'), (b'bg-darkBlue', 'Dark Blue')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('person_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('classes', models.ManyToManyField(related_name='Classes', to='askmath.Classe', blank=True, help_text='Choose classe that this student.', null=True, verbose_name='Classes')),
                ('current_classe', models.ForeignKey(related_name='Current Classe', blank=True, to='askmath.Classe', help_text='Choose the current classe to this student.', null=True, verbose_name='Current Classe')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_scores', models.IntegerField(default=0, verbose_name='Todos os Pontos')),
                ('last_scores', models.IntegerField(default=0, verbose_name='\xdaltimos Pontos')),
                ('new_scores', models.IntegerField(default=0, verbose_name='Novos Pontos')),
                ('last_new_scores', models.IntegerField(default=0, verbose_name='\xdaltimos pontos ganhos')),
                ...
                ('date_start_new_round', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Data de in\xedcio da Rodada')),
                ('date_end_new_round', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Data de t\xe9rmino da Rodada')),
                ('last_winner', models.BooleanField(default=False)),
                ('creation', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Cria\xe7\xe3o')),
                ('exists', models.BooleanField(default=True)),
                ('student', models.ForeignKey(verbose_name='Estudante', to='askmath.Student', unique=True)),
            ],
            options={
                'ordering': ['creation'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Cria\xe7\xe3o')),
                ('exists', models.BooleanField(default=True, verbose_name='Existe')),
                ('creator', models.ForeignKey(verbose_name='Criador', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Escolha uma cor para este t\xf3pico.', max_length=50, verbose_name='Cor', choices=[(b'bg-lime', 'Lime'), (b'bg-green', 'Green'), (b'bg-emerald', 'Emerald'), (b'bg-teal', 'Teal'), (b'bg-blue', 'Blue'), (b'bg-cyan', 'Cyan'), (b'bg-cobalt', 'Cobalt'), (b'bg-indigo', 'Indigo'), (b'bg-violet', 'Violet'), (b'bg-magenta', 'Magenta'), (b'bg-orange', 'Orange'), (b'bg-amber', 'Amber'), (b'bg-yellow', 'Yellow'), (b'bg-brown', 'Brown'), (b'bg-olive', 'Emerald'), (b'bg-steel', 'Steel'), (b'bg-mauve', 'Mauve'), (b'bg-taupe', 'Taupe'), (b'bg-gray', 'Gray'), (b'bg-lightBlue', 'Light Blue'), (b'bg-lightRed', 'Light Red'), (b'bg-lightGreen', 'Light Green'), (b'bg-lighterBlue', 'Lighter Blue'), (b'bg-lightOlive', 'Light Olive'), (b'bg-lightOrange', 'Light Orange'), (b'bg-darkBrown', 'Dark Brown'), (b'bg-darkIndigo', 'Dark Indigo'), (b'bg-darkCyan', 'Dark Cyan'), (b'bg-darkCobalt', 'Dark Cobalt'), (b'bg-darkTeal', 'Dark Teal'), (b'bg-darkEmerald', 'Dark Emerald'), (b'bg-darkGreen', 'Dark Green'), (b'bg-darkOrange', 'Dark Orange'), (b'bg-darkViolet', 'Dark Violet'), (b'bg-darkBlue', 'Dark Blue')])),
                ('creation', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Cria\xe7\xe3o')),
                ('exists', models.BooleanField(default=True, verbose_name='Existe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Escolha uma cor para o v\xeddeo.', max_length=50, verbose_name='Cor', choices=[(b'bg-lime', 'Lime'), (b'bg-green', 'Green'), (b'bg-emerald', 'Emerald'), (b'bg-teal', 'Teal'), (b'bg-blue', 'Blue'), (b'bg-cyan', 'Cyan'), (b'bg-cobalt', 'Cobalt'), (b'bg-indigo', 'Indigo'), (b'bg-violet', 'Violet'), (b'bg-magenta', 'Magenta'), (b'bg-orange', 'Orange'), (b'bg-amber', 'Amber'), (b'bg-yellow', 'Yellow'), (b'bg-brown', 'Brown'), (b'bg-olive', 'Emerald'), (b'bg-steel', 'Steel'), (b'bg-mauve', 'Mauve'), (b'bg-taupe', 'Taupe'), (b'bg-gray', 'Gray'), (b'bg-lightBlue', 'Light Blue'), (b'bg-lightRed', 'Light Red'), (b'bg-lightGreen', 'Light Green'), (b'bg-lighterBlue', 'Lighter Blue'), (b'bg-lightOlive', 'Light Olive'), (b'bg-lightOrange', 'Light Orange'), (b'bg-darkBrown', 'Dark Brown'), (b'bg-darkIndigo', 'Dark Indigo'), (b'bg-darkCyan', 'Dark Cyan'), (b'bg-darkCobalt', 'Dark Cobalt'), (b'bg-darkTeal', 'Dark Teal'), (b'bg-darkEmerald', 'Dark Emerald'), (b'bg-darkGreen', 'Dark Green'), (b'bg-darkOrange', 'Dark Orange'), (b'bg-darkViolet', 'Dark Violet'), (b'bg-darkBlue', 'Dark Blue')])),
        ...
        migrations.AddField(
            ...
            name='discipline',
            field=models.ForeignKey(related_name='Disciplina', verbose_name='Disciplina', to='askmath.Discipline'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='answeredquestionshistoric',
            name='item',
            field=models.ForeignKey(related_name='Item', verbose_name='Item', to='askmath.Item'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='answeredquestionshistoric',
            name='lesson',
            field=models.ForeignKey(related_name='Li\xe7\xe3o', verbose_name='Li\xe7\xe3o', to='askmath.Lesson'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='answeredquestionshistoric',
            name='question',
            field=models.ForeignKey(related_name='Quest\xe3o', verbose_name='Quest\xe3o', to='askmath.Question'),
            preserve_default=True,
        ),
        migrations.AddField(
