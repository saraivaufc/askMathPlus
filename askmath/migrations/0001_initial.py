    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Choose a color for the discipline.', max_length=50, verbose_name='Color', choices=[(b'bg-lime', b'Lime'), (b'bg-green', b'Green'), (b'bg-emerald', b'Emerald'), (b'bg-teal', b'Teal'), (b'bg-blue', b'Blue'), (b'bg-cyan', b'Cyan'), (b'bg-cobalt', b'Cobalt'), (b'bg-indigo', b'Indigo'), (b'bg-violet', b'Violet'), (b'bg-magenta', b'Magenta'), (b'bg-orange', b'Orange'), (b'bg-amber', b'Amber'), (b'bg-yellow', b'Yellow'), (b'bg-brown', b'Brown'), (b'bg-olive', b'Emerald'), (b'bg-steel', b'Steel'), (b'bg-mauve', b'Mauve'), (b'bg-taupe', b'Taupe'), (b'bg-gray', b'Gray'), (b'bg-lightBlue', b'Light Blue'), (b'bg-lightRed', b'Light Red'), (b'bg-lightGreen', b'Light Green'), (b'bg-lighterBlue', b'Lighter Blue'), (b'bg-lightOlive', b'Light Olive'), (b'bg-lightOrange', b'Light Orange')])),
                ('creation', models.DateTimeField(default=datetime.datetime.now, verbose_name='Creation')),
                ('exists', models.BooleanField(default=True, verbose_name='Exists')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Choose a color for the lesson.', max_length=50, verbose_name='Color', choices=[(b'bg-lime', b'Lime'), (b'bg-green', b'Green'), (b'bg-emerald', b'Emerald'), (b'bg-teal', b'Teal'), (b'bg-blue', b'Blue'), (b'bg-cyan', b'Cyan'), (b'bg-cobalt', b'Cobalt'), (b'bg-indigo', b'Indigo'), (b'bg-violet', b'Violet'), (b'bg-magenta', b'Magenta'), (b'bg-orange', b'Orange'), (b'bg-amber', b'Amber'), (b'bg-yellow', b'Yellow'), (b'bg-brown', b'Brown'), (b'bg-olive', b'Emerald'), (b'bg-steel', b'Steel'), (b'bg-mauve', b'Mauve'), (b'bg-taupe', b'Taupe'), (b'bg-gray', b'Gray'), (b'bg-lightBlue', b'Light Blue'), (b'bg-lightRed', b'Light Red'), (b'bg-lightGreen', b'Light Green'), (b'bg-lighterBlue', b'Lighter Blue'), (b'bg-lightOlive', b'Light Olive'), (b'bg-lightOrange', b'Light Orange')])),
                ('visible', models.BooleanField(default=False, help_text='Select this option to leave visible lesson at all.')),
                ('creation', models.DateTimeField(default=datetime.datetime.now, verbose_name='Creation')),
                ('exists', models.BooleanField(default=True)),
                ('discipline', models.ForeignKey(verbose_name='Discipline', to='askmath.Discipline', help_text='Choose the disciplines which is lesson belongs.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Choose a color for the question.', max_length=50, verbose_name='Color', choices=[(b'bg-lime', b'Lime'), (b'bg-green', b'Green'), (b'bg-emerald', b'Emerald'), (b'bg-teal', b'Teal'), (b'bg-blue', b'Blue'), (b'bg-cyan', b'Cyan'), (b'bg-cobalt', b'Cobalt'), (b'bg-indigo', b'Indigo'), (b'bg-violet', b'Violet'), (b'bg-magenta', b'Magenta'), (b'bg-orange', b'Orange'), (b'bg-amber', b'Amber'), (b'bg-yellow', b'Yellow'), (b'bg-brown', b'Brown'), (b'bg-olive', b'Emerald'), (b'bg-steel', b'Steel'), (b'bg-mauve', b'Mauve'), (b'bg-taupe', b'Taupe'), (b'bg-gray', b'Gray'), (b'bg-lightBlue', b'Light Blue'), (b'bg-lightRed', b'Light Red'), (b'bg-lightGreen', b'Light Green'), (b'bg-lighterBlue', b'Lighter Blue'), (b'bg-lightOlive', b'Light Olive'), (b'bg-lightOrange', b'Light Orange')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Choose a color for the topic.', max_length=50, verbose_name='Color', choices=[(b'bg-lime', b'Lime'), (b'bg-green', b'Green'), (b'bg-emerald', b'Emerald'), (b'bg-teal', b'Teal'), (b'bg-blue', b'Blue'), (b'bg-cyan', b'Cyan'), (b'bg-cobalt', b'Cobalt'), (b'bg-indigo', b'Indigo'), (b'bg-violet', b'Violet'), (b'bg-magenta', b'Magenta'), (b'bg-orange', b'Orange'), (b'bg-amber', b'Amber'), (b'bg-yellow', b'Yellow'), (b'bg-brown', b'Brown'), (b'bg-olive', b'Emerald'), (b'bg-steel', b'Steel'), (b'bg-mauve', b'Mauve'), (b'bg-taupe', b'Taupe'), (b'bg-gray', b'Gray'), (b'bg-lightBlue', b'Light Blue'), (b'bg-lightRed', b'Light Red'), (b'bg-lightGreen', b'Light Green'), (b'bg-lighterBlue', b'Lighter Blue'), (b'bg-lightOlive', b'Light Olive'), (b'bg-lightOrange', b'Light Orange')])),
                ('creation', models.DateTimeField(default=datetime.datetime.now, verbose_name='Creation')),
                ('exists', models.BooleanField(default=True, verbose_name='Exists')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=askMathPlus.components_metro.generate_color, help_text='Choose a color for the video.', max_length=50, verbose_name='Color', choices=[(b'bg-lime', b'Lime'), (b'bg-green', b'Green'), (b'bg-emerald', b'Emerald'), (b'bg-teal', b'Teal'), (b'bg-blue', b'Blue'), (b'bg-cyan', b'Cyan'), (b'bg-cobalt', b'Cobalt'), (b'bg-indigo', b'Indigo'), (b'bg-violet', b'Violet'), (b'bg-magenta', b'Magenta'), (b'bg-orange', b'Orange'), (b'bg-amber', b'Amber'), (b'bg-yellow', b'Yellow'), (b'bg-brown', b'Brown'), (b'bg-olive', b'Emerald'), (b'bg-steel', b'Steel'), (b'bg-mauve', b'Mauve'), (b'bg-taupe', b'Taupe'), (b'bg-gray', b'Gray'), (b'bg-lightBlue', b'Light Blue'), (b'bg-lightRed', b'Light Red'), (b'bg-lightGreen', b'Light Green'), (b'bg-lighterBlue', b'Lighter Blue'), (b'bg-lightOlive', b'Light Olive'), (b'bg-lightOrange', b'Light Orange')])),
