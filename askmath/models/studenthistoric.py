...
class StudentHistoric(models.Model):
    ...
    answered_questions_historic = models.ManyToManyField('AnsweredQuestionsHistoric',
                                                         verbose_name=_(u"Answered Questions Historic"),
                                                         related_name=_(u"Answered Questions Historic"), null=True,
                                                         blank=True)
    help_questions_historic = models.ManyToManyField('HelpQuestionsHistoric', related_name=("Help Question Historic"),
                                                     verbose_name=_(u"Answered Questions Historic"), null=True,
                                                     blank=True)
    skipped_questions_historic = models.ManyToManyField('SkippedQuestionsHistoric',
                                                        related_name=("Skipped Question Historic"),
                                                        verbose_name=_(u"Answered Questions Historic"), null=True,
                                                        blank=True)
