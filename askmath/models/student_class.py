...
class StudentClasse(Person):
	student = models.ForeignKey('Person', verbose_name=_(u"Person"), unique=True)
	classes = models.ManyToManyField('Classe', verbose_name=_(u"Classes"), related_name="Classes", null=True,
									 blank=True,
									 help_text=_(u"Choose classe that this student."))
	current_classe = models.ForeignKey('Classe', verbose_name=_(u"Current Classe"), related_name="Current Classe",
	...
	class Meta(Person.Meta):
		verbose_name = _(u'StudentClass')
		verbose_name_plural = _(u'StudentsClass')
