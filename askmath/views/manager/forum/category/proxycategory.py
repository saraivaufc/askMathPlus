...
class ProxyCategory(ICategory):
    ...
    def view_categories(self, request, message=None):
        if request.user.has_perm("askmath.read_category")  and request.user.has_perm("askmath.access_manager"):
            try:
    ...
    def add_category(self, request, message=None):
        if request.user.has_perm("askmath.write_category")  and request.user.has_perm("askmath.access_manager"):
            try:
