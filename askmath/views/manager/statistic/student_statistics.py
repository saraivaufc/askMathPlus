...
class StudentStatistics():
	...
	def lessons_completed(self, request, id_student):
		...
		return render(request, "askmath/manager/statistic/student_statistics/list_lessons.html", {'request': request, 'student': student, 'studentLessonStates': studentLessonStates, 'type':_("completeds")})
