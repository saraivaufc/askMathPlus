    ...
    def view_question(self, request, discipline, lesson, question=None, definitive=False):
        ...
        try:
            ...
            try:
                ...
                return HttpResponseRedirect(reverse('askmath:content_question_view', kwargs={'id_discipline': discipline.id, 'id_lesson': lesson.id}))
        ...
        return render(request, "askmath/content/question/view_question.html", {'request': request, 'discipline': discipline, 'lesson': lesson, 'studentlessonstate': studentlessonstate,'lesson_complete': lesson_complete ,'experience_level': experience_level,'question': question})
