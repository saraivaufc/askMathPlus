...
urlpatterns = patterns('',
	 ...
	 url(r'^view_removed/$', proxy_category.view_disciplines_removed,
			 name="manager_discipline_view_removed"),
	 url(r'^view/discipline=(?P<id_discipline>\d+)/$', proxy_category.view_discipline, name="manager_discipline_view"),
