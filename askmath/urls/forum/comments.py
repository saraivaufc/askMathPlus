...
urlpatterns = patterns('',
                       ...
                       url(
                           r'^remove/category=(?P<id_category>\d+)/topic=(?P<id_topic>\d+)/comment=(?P<id_comment>\d+)/$',
                           proxy_comment.remove_comment, name="forum_comment_remove"),
                       url(r'^edit/category=(?P<id_category>\d+)/topic=(?P<id_topic>\d+)/comment=(?P<id_comment>\d+)/$',
                           proxy_comment.edit_comment, name="forum_comment_edit"),
