...
urlpatterns = patterns('',
                       ...
                       url(
                           r'^jump_question/discipline=(?P<id_discipline>\d+)/lesson=(?P<id_lesson>\d+)/question=(?P<id_question>\d+)/$',
                           proxy_category.jump_question, name="content_question_jump"),
                       url(
                           r'^choose_skipped_question/discipline=(?P<id_discipline>\d+)/lesson=(?P<id_lesson>\d+)/question=(?P<id_question>\d+)/$',
                           proxy_category.choose_skipped_question, name="content_question_choose_skipped"),
                       url(
                           r'^help/discipline=(?P<id_discipline>\d+)/lesson=(?P<id_lesson>\d+)/question=(?P<id_question>\d+)/$',
